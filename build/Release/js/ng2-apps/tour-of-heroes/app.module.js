System.register(['@angular/core', '@angular/platform-browser', '@angular/forms', '@angular/http', 'angular-in-memory-web-api', './in-memory-data.service', './rxjs-extensions', './app.component', './dashboard.component', './hero-detail.component', './heroes.component', './hero.service', './app-routing.module', './hero-search.component'], function(exports_1, context_1) {
    ...
    var core_1, platform_browser_1, forms_1, http_1, angular_in_memory_web_api_1, in_memory_data_service_1, app_component_1, dashboard_component_1, hero_detail_component_1, heroes_component_1, hero_service_1, app_routing_module_1, hero_search_component_1;
    var AppModule;
    return {
        setters:[
            function (core_1_1) {
